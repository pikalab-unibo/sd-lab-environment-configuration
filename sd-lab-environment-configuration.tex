...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SD Lab -- Environment Configuration
% Giovanni Ciatto
...
\usepackage{sd-lab-environment-configuration}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%			\item \alert{notice that JDK versions $\geq 15$ are not compatible with Gradle $\leq 6.6.1$}
    ...
    %
    \begin{center}
        \includegraphics[width=.4\linewidth]{figures/console_versions.png}
    \end{center}
    %
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item[$\rightarrow$] \texttt{C:$\backslash$Program Files$\backslash$Java$\backslash$jdk\_17.X\_Y} \hint{your paths may}
            \item[] \texttt{C:$\backslash$Program Files$\backslash$Gradle$\backslash$gradle-8.X.Y} \hint{be different}
        \end{itemize}
    \end{itemize}
    %
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item[$\rightarrow$] \texttt{/usr/lib/jvm/java-17.X.Y-openjdk-amd64/}\hint{your paths may}
            \item[] \texttt{/opt/gradle/gradle-8.X.Y}\hint{be different}
        \end{itemize}
    \end{itemize}
    %
...
\frametitle{Configure Your Own Computer}
    ...
    \begin{block}{}
        In case of troubles, you can post on the \href{\generalForum}{Students' Forum} \alert{describing your issues}, your computer's features, and the steps you already performed :)
    \end{block}
